...
- Duplicate message from current userEntity [#509](https://github.com/GetStream/stream-js/pull/509)
...
- Ban userEntity by ip [#485](https://github.com/GetStream/stream-js/pull/485)
...
- New functions to shadow ban a userEntity from one or all channels [#447](https://github.com/GetStream/stream-chat-js/pull/447)
...
- Added support for `userEntity.deleted` event [b3c328a](https://github.com/GetStream/stream-chat-js/commit/b3c328aa15af4db8bdd07d57effbd21fbd6ae600)
...
- Reverting [c5413c0](https://github.com/GetStream/stream-chat-js/commit/c5413c07e6743e056b04ade7ccacebeb0f2b1b4f)
  ...
  3. own_reactions doesn't contain userEntity object always. So that use case will need handling as well.
...
- Fix for issue [#133](https://github.com/GetStream/stream-chat-js/issues/133) - Updating userEntity object in client, when `userEntity.updated` is received corresponding to userEntity of client
...
- Improved userEntity presence support. If listening to userEntity presence, channel.state.members and channel.state.watchers
  are now automatically updated with the userEntity's online/offline presence.
...
- countUnread can be called without any parameters now client-side and it will default to current userEntity's read state
...
- userEntity.status.changed renamed to userEntity.presence.changed
