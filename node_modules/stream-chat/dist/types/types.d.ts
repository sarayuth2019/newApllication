...
export declare type MessageBase<AttachmentType = UnknownType, MessageType = UnknownType, UserType = UnknownType> = MessageType & {
    ...
    text?: string;
    userEntity?: UserResponse<UserType> | null;
    user_id?: string;
};
