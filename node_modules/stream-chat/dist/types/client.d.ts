...
export declare class StreamChat<AttachmentType extends UnknownType = UnknownType, ChannelType extends UnknownType = UnknownType, CommandType extends string = LiteralStringForUnion, EventType extends UnknownType = UnknownType, MessageType extends UnknownType = UnknownType, ReactionType extends UnknownType = UnknownType, UserType extends UnknownType = UnknownType> {
     ...
     */
    connectUser: (userEntity: UserResponse<UserType>, userTokenOrProvider: TokenOrProvider) => ConnectAPIResponse<ChannelType, CommandType, UserType>;
    /**
     ...
     * @return {ConnectAPIResponse<ChannelType, CommandType, UserType>} Returns a promise that resolves when the connection is setup
     */
    setUser: (userEntity: UserResponse<UserType>, userTokenOrProvider: TokenOrProvider) => ConnectAPIResponse<ChannelType, CommandType, UserType>;
    _setToken: (userEntity: UserResponse<UserType>, userTokenOrProvider: TokenOrProvider) => Promise<void>;
    _setUser(userEntity: UserResponse<UserType>): void;
    /**
     ...
     * @return {ConnectAPIResponse<ChannelType, CommandType, UserType>} Returns a promise that resolves when the connection is setup
     */
    setGuestUser(userEntity: UserResponse<UserType>): Promise<void | import("./types").ConnectionOpen<ChannelType, CommandType, UserType>>;
    /**
    ...
    sendFile(url: string, uri: string | NodeJS.ReadableStream | Buffer | File, name?: string, contentType?: string, userEntity?: UserResponse<UserType>): Promise<SendFileAPIResponse>;
    ...
    _updateUserReferences(userEntity: UserResponse<UserType>): void;
    ...
    translateMessage(messageId: string, language: string): Promise<APIResponse & MessageType & {
        ...
        userEntity?: UserResponse<UserType> | null | undefined;
