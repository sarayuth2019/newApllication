...
**NOTE:** If you utilize the `setAnonymousUser` function you must account for this in your userEntity types.
...
```typescript
function isChatUser1(userEntity: ChatUser1 | ChatUser2): userEntity is ChatUser1 {
  return (userEntity as ChatUser1).age !== undefined;
}
